...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('addy_entryMode', models.CharField(choices=[('manual', 'Manual'), ('auto', 'Auto')], default='manual', max_length=20)),
                ('addy_type', models.CharField(choices=[('shipping', 'Shipping'), ('billing', 'Billing')], max_length=20)),
                ...
                ('formatted_addy', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user', 'product'), name='unique_user_product'), models.UniqueConstraint(fields=('session_key', 'product'), name='unique_session_product')],
            },
        ),
    ]
